#Done add a movements active last turn variable to Imove and make it reset after the player turn ends
#Done so extra effects can know what happened before the match.
#Done find a way to get targeting of cells, for explosion effects and such.
